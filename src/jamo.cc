...
const std::set<wchar_t> CHOSUNG_SET{CHOSUNG, CHOSUNG + 19};
const std::set<wchar_t> JONGSUNG_SET{JONGSUNG + 1, JONGSUNG + 28};
...
void JamoConverter::initializeJamos(bool fillEmptyJongsung, wchar_t emptyJongsung) {
...
std::wstring JamoConverter::compose(std::wstring text) const {
...
std::wstring JamoConverter::decompose(std::wstring text) const {
...
wchar_t JamoConverter::getOneHangulFromJamo(wchar_t chosung, wchar_t jungsung) const {
...
wchar_t JamoConverter::getOneHangulFromJamo(wchar_t chosung, wchar_t jungsung, wchar_t jongsung) const {
...
std::wstring JamoConverter::getJamosFromHangul(const wchar_t character) const {
...
const JamoConverter defaultJamoConverter{false};
