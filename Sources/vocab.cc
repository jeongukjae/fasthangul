...
const size_t fasthangul::vocab::Vocab::find(std::wstring word) {
...
const bool fasthangul::vocab::Vocab::has(std::wstring word) {
  auto found = vocabData.find(word);
  return found != vocabData.end();
}

const std::wstring_view fasthangul::vocab::Vocab::at(size_t index) {
